        ...
        <section className="inicio" id="inicio">
            ...
            <div className="titulo">
                ...
                <h1 data-aos="fade-up" data-aos-delay="800">
                    <FormattedMessage
                        id='name'
                        defaultMessage='I am Arsema Tefera'
                    />
                </h1>
                <p data-aos="fade-up" data-aos-delay="1000">
                    <FormattedMessage
                        id='rol'
                        defaultMessage='Full-stack and Mobile app developer'
                    />
                </p>
                ...
                <div className="wrapper">
                    ...
                    <a className="button" href="https://github.com/arsema16/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1400">
                        <div className="icon">
                    ...
                    <a className="button" href="https://api.whatsapp.com/send?phone=0956457728" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1800">
                        <div className="icon">
